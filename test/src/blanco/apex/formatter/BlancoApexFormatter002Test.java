...
public class BlancoApexFormatter002Test {
	// private static final String TARGET_FILE1 =
	// "./test/data/apex/MySimpleTest.cls";
	private static final String TARGET_FILE1 = "/home/tosiki/workspace/apex-lang/src.apex/MapUtilsTest.cls";
